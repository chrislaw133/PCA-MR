...
beta_dir  <- "/deac/bio/lackGrp/lawrcm22/serotonin_eqtl/GLS_betavectors"
ld_dir    <- "/deac/bio/lackGrp/lawrcm22/serotonin_eqtl/GLS_snpcorr"

out_dir   <- "/deac/bio/lackGrp/lawrcm22/serotonin_eqtl/results/generalized_methods"
