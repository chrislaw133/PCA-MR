...
## PATHS
############################################################
gene_file <- "/deac/bio/lackGrp/lawrcm22/serotonin_eqtl/snpcorrelations/genesandinstruments.txt"
beta_dir  <- "/deac/bio/lackGrp/lawrcm22/serotonin_eqtl/beta_vectors"
ld_dir    <- "/deac/bio/lackGrp/lawrcm22/serotonin_eqtl/snpcorrelations"

out_dir   <- "/deac/bio/lackGrp/lawrcm22/serotonin_eqtl/results/pca_methods_nof_test"
